...
public:
    ...
    void printYearNewspaper () {
        cout << getYear(); // access to public getYear(), that in this class has protectedaccess
    }
    void printNameNewspaper() {
        cout << getName(); // access to getName(), name that can not be accessed becauseit is private
    }
    void printNumber() {
        cout << number;
    }
...
public:
    ...
    using Newspaper::print; // function print from Publication becomes public forDailyNewspaper
    using Newspaper::printNumber; // function printNumber from Publication becomes publicfor DailyNewspaper
};
int main() {
